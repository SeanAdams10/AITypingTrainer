...
def create_app(config: dict | None = None) -> flask.Flask:
    ...
    def api_list_tables() -> flask.Response:
    ...
    def api_table_content(table_name: str) -> flask.Response:
    ...
    def api_backup_table(table_name: str) -> flask.Response:
    ...
    def api_restore_table(table_name: str) -> 'flask.Response':
    ...
    def api_delete_all_rows(table_name: str) -> 'flask.Response':
