...
class LLMNgramService:
    ...
    def get_words_with_ngrams(
        ...
        prompt = (
            f"You are an expert on words and lexicography. "
            f"Please can you give me a list of words that include the following ngrams "
            f"{ngram_str}. "
            f"Can you please assemble this list in random order into a space delimited string, "
            f"with a maximum length of {max_length} characters. "
