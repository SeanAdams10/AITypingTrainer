...
class PracticeGenerator:
    ...
    @staticmethod
    def create_snippet_from_ngrams(ngrams: list, min_length: int = 50, max_length: int = 200, name: Optional[str] = None) -> dict:
        """
        Create a practice snippet from a list of n-grams. This is a stub for testing and can be monkeypatched.
        """
        return {}
    ...
    #todo rebuild this entire file completely
    def create_practice_snippet(self) -> Tuple[int, str]:
        ...
        try:
            ...
            snippet_id = cursor.lastrowid if cursor.lastrowid is not None else -1
