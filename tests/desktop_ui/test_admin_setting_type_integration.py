...
def admin_ui(qtapp: QApplication, mock_db_manager: MagicMock) -> Generator[AdminUI, None, None]:
    ...
    with (
        patch.object(admin_module, "DatabaseManager", mock_db_class),
...
class TestAdminSettingTypeIntegration:
    ...
    def test_admin_has_manage_setting_types_button(self, admin_ui: AdminUI) -> None:
    ...
    def test_manage_setting_types_method_exists(self, admin_ui: AdminUI) -> None:
    ...
    def test_manage_setting_types_passes_db_manager(self, admin_ui: AdminUI) -> None:
        ...
        with patch.dict(
            "sys.modules",
            {
                "desktop_ui.setting_type_manager": MagicMock(
                    SettingTypeManagerWindow=mock_window_class
                )
            },
        ):
            # Call the method
    ...
    def test_manage_setting_types_handles_import_error(self, admin_ui: AdminUI) -> None:
    ...
    def test_manage_setting_types_handles_runtime_error(self, admin_ui: AdminUI) -> None:
