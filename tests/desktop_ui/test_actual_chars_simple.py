...
def create_keystroke(position: int, char: str, timestamp: float = 1.0, is_error: int = 0) -> Dict[str, Any]:
...
def test_actual_chars_basic_calculation(app):
    ...
    assert stats["backspace_count"] == 0, f"Expected backspace_count=0, got {stats['backspace_count']}"
