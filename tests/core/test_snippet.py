...
def test_snippet_creation_valid(
    ...
    valid_snippet_data: Dict[str, Union[int, str]]
) -> None:
    category_id = int(valid_snippet_data["category_id"])
...
def test_snippet_content_splitting_boundaries(snippet_category_fixture, snippet_manager):
