...
class TestNGramAnalyticsService:
    ...
    def test_dual_insert_creates_records_in_both_tables(
        ...
        history_row = db_manager.fetchone("SELECT COUNT(*) AS cnt FROM ngram_speed_summary_hist")
    ...
    def test_history_table_accumulates_all_records(
        ...
        # First refresh
        service.refresh_speed_summaries(user_id, keyboard_id)
        history_row_1 = db_manager.fetchone("SELECT COUNT(*) AS cnt FROM ngram_speed_summary_hist")
        ...
        # Second refresh
        service.refresh_speed_summaries(user_id, keyboard_id)
        history_row_2 = db_manager.fetchone("SELECT COUNT(*) AS cnt FROM ngram_speed_summary_hist")
    ...
    def test_slowest_n_filters_can_eliminate_results(
        ...
        service = NGramAnalyticsService(db_manager, NGramManager(db_manager))
    ...
    def test_history_table_schema_compatibility(self, db_manager: DatabaseManager) -> None:
