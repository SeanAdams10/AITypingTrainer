...
# This test suite covers advanced NGram model and NGramManager class functionality
...
#         (part_id, snippet_id, 1, "test typing content"),
#     )
...
# # All test NGram objects and dicts in this file should include ngram_id as a UUID string.
