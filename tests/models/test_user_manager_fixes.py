...
class TestUserManagerDatabaseAccessFixes:
    ...
    def test_list_all_users_empty_database(
        self, user_manager: UserManager, mock_db_manager: Mock
    ) -> None:
    ...
    def test_get_user_by_id_found(
        self, user_manager: UserManager, mock_db_manager: Mock, sample_user_data: Dict[str, Any]
    ) -> None:
    ...
    def test_user_exists_true(self, user_manager: UserManager, mock_db_manager: Mock) -> None:
    ...
    def test_user_exists_false(self, user_manager: UserManager, mock_db_manager: Mock) -> None:
    ...
    def test_validate_email_uniqueness_duplicate(
        ...
        with pytest.raises(
            UserValidationError, match="Email address 'duplicate@example.com' must be unique"
        ):
