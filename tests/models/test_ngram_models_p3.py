...
# This test suite specifically covers backspace handling in the NGramManager class
...
# from models.ngram_manager import NGramManager, MIN_NGRAM_SIZE, MAX_NGRAM_SIZE
...
# @pytest.fixture
# def five_keystrokes_with_backspace(
...
#             keystroke_id=str(uuid.uuid4()),
#             session_id=test_practice_session.session_id,
#             keystroke_time=now + datetime.timedelta(milliseconds=1800),
#             keystroke_char="h",
#             expected_char="h",
#             is_error=False,
...
#             keystroke_id=str(uuid.uuid4()),
#             session_id=test_practice_session.session_id,
#             keystroke_time=now + datetime.timedelta(milliseconds=1970),
#             keystroke_char="e",
#             expected_char="e",
#             is_error=False,
#             time_since_previous=170,
#         ),
#     ]
#     return keystrokes
...
#     This test class verifies how the NGramManager handles backspace characters
...
#     def test_five_keystrokes_with_backspace(
#         self,
#         temp_db: DatabaseManager,
#         test_practice_session: Session,
#         five_keystrokes_with_backspace: List[Keystroke],
#     ) -> None:
#         """
...
#         # Create and analyze the NGramManager
#         analyzer = NGramManager(test_practice_session, five_keystrokes_with_backspace, temp_db)
...
#             "Should be exactly 3 speed n-grams in the database (2 bigrams, 1 trigram)"
#         )
...
#         assert abs(speed_ngrams[2][2] - expected_avg_time) < 0.01, (
#             f"Database 'The' time should be ~{expected_avg_time}ms avg"
#         )
...
#     def test_five_keystrokes_backspace_at_second(
#         self, temp_db, test_practice_session, five_keystrokes_backspace_at_second
#     ):
#         """
...
#         # Create and analyze the NGramManager
#         analyzer = NGramManager(
#             test_practice_session, five_keystrokes_backspace_at_second, temp_db
#         )
#         analyzer.analyze(min_size=2, max_size=5)
...
#     def test_five_keystrokes_backspace_at_third_no_mistake(
#         self, temp_db, test_practice_session, five_keystrokes_backspace_at_third_no_mistake
#     ):
#         """
...
#         # Create and analyze the NGramManager
#         analyzer = NGramManager(
#             test_practice_session, five_keystrokes_backspace_at_third_no_mistake, temp_db
#         )
#         analyzer.analyze(min_size=2, max_size=5)
...
#     def test_five_keystrokes_space_at_third(
#         self, temp_db, test_practice_session, five_keystrokes_space_at_third
#     ):
#         """
...
#         # Create and analyze the NGramManager
#         analyzer = NGramManager(test_practice_session, five_keystrokes_space_at_third, temp_db)
#         analyzer.analyze(min_size=2, max_size=5)
...
#     def test_five_keystrokes_space_at_second(
#         self, temp_db, test_practice_session, five_keystrokes_space_at_second
#     ):
#         """
...
#         # Create and analyze the NGramManager
#         analyzer = NGramManager(test_practice_session, five_keystrokes_space_at_second, temp_db)
#         analyzer.analyze(min_size=2, max_size=5)
...
#         assert abs(speed_ngrams[2][2] - 156.67) < 0.5, (
#             f"Database 'cat' time should be ~156.67ms avg (470ms/3), got {speed_ngrams[2][2]}"
#         )
...
#     def test_five_keystrokes_space_at_fifth(
#         self, temp_db, test_practice_session, five_keystrokes_space_at_fifth
#     ):
#         """
...
#         # Create and analyze the NGramManager
#         analyzer = NGramManager(test_practice_session, five_keystrokes_space_at_fifth, temp_db)
#         analyzer.analyze(min_size=2, max_size=5)
...
#         assert abs(speed_ngrams[5][2] - 450) < 0.5, (
#             f"Database 'Then' time should be ~450ms avg (1800ms/4), got {speed_ngrams[5][2]}"
#         )
...
#     def test_five_keystrokes_th_space_th(temp_db, test_practice_session) -> List[Keystroke]:
#         """
...
#     analyzer = NGramManager(test_practice_session, MIN_NGRAM_SIZE, MAX_NGRAM_SIZE)
...
#             assert abs(ngram.time_ms - 300) < 1, (
#                 f"Expected 'Th' ngram time ~300ms, got {ngram.time_ms}ms"
#             )
