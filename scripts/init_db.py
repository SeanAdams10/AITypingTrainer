...
including text_category and text_snippets tables required by the library manager.
"""
import os
import sqlite3
...
# Create the text_snippets table if it doesn't exist
cursor.execute("""
...
if cursor.fetchone()[0] == 0:
    ...
    cursor.execute("""
        INSERT INTO text_snippets (category_id, snippet_name, text) 
