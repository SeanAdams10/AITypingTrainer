...
class SettingTypeDialog(QDialog):
    ...
    def __init__(
        ...
        self.setWindowTitle("Edit Setting Type" if self.is_edit_mode else "Add Setting Type")
    ...
    def setup_ui(self) -> None:
        ...
        self.is_system_checkbox.setToolTip("System setting types cannot be deleted")
        form_layout.addRow("", self.is_system_checkbox)

        # Is Active checkbox
        self.is_active_checkbox = QCheckBox("Active")
        self.is_active_checkbox.setChecked(True)
        self.is_active_checkbox.setToolTip("Inactive setting types are hidden from users")
    ...
    def populate_fields(self, setting_type: SettingType) -> None:
        ...
        entity_index = self.entity_type_combo.findText(setting_type.related_entity_type)
        if entity_index >= 0:
