...
class SnippetScaffold(QtWidgets.QMainWindow):
    ...
    def add_snippet(self) -> None:
        ...
        if not content:
            QtWidgets.QMessageBox.warning(self, "Validation Error", "Snippet content cannot be empty.")
            return
        ...
        try:
            ...
            QtWidgets.QMessageBox.information(self, "Success", f"Snippet '{name}' created successfully with ID {snippet_id}")
        except ValueError as e:
    ...
    def load_selected_snippet(self, item: QtWidgets.QListWidgetItem) -> None:
        ...
        try:
            ...
            if snippet:
                ...
                self.statusBar().showMessage(f"Loaded snippet {snippet.snippet_id}: {snippet.snippet_name}", 3000)
            else:
                QtWidgets.QMessageBox.warning(self, "Error", f"Snippet with ID {snippet_id} not found.")
        except ValueError as e:
