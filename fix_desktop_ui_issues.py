...
def fix_docstring_issues():
    ...
    fixes = {
        ...
        "ngram_llm_screen.py": [
            (r'(    def __init__\(self, parent: Optional\[Any\] = None\) -> None:)', r'    def __init__(self, parent: Optional["QWidget"] = None) -> None:'),
        ...
        "splash.py": [
            ...
            (r'(    def __init__\(self, graphql=None, config: Optional\[SplashConfig\] = None\) -> None:)', r'    def __init__(self, graphql: Optional[Any] = None, config: Optional[SplashConfig] = None) -> None:'),
